...
public class BSPCommission_Page {
    ...
    By Txt_AirlineName = By.xpath("//input[@id=\"id-AirlineName(OnlyGDSAirlines)\"]");
    ...
    By Rbtn_Airport = By.xpath("//p-radiobutton[.//input[@id=\"id-Level:-Airport\"]]");
    ...
    By Rbtn_City = By.xpath("//p-radiobutton[.//input[@id=\"id-Level:-City\"]]");
    By Txt_OriginCity = By.xpath("//input[@id=\"id-Origincities\"]");
    By Txt_DestinationCity = By.xpath("//input[@id=\"id-Destinationcities\"]");
    By Rbtn_Country = By.xpath("//p-radiobutton[.//input[@id=\"id-Level:-Country\"]]");
