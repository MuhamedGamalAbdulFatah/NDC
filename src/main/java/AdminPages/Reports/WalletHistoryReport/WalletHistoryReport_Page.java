...
public class WalletHistoryReport_Page {
    ...
    public static final String BUTTON_CLASS_P_ELEMENT_P_RIPPLE_P_DATEPICKER_TRIGGER_NG_TNS_C_47_3_P_BUTTON_P_COMPONENT_P_BUTTON_ICON_ONLY_NG_STAR_INSERTED = "//button[@class=\"p-element p-ripple p-datepicker-trigger ng-tns-c47-3 p-button p-component p-button-icon-only ng-star-inserted\"]";
    public static final String BUTTON_CLASS_P_ELEMENT_P_RIPPLE_P_DATEPICKER_TRIGGER_NG_TNS_C_47_4_P_BUTTON_P_COMPONENT_P_BUTTON_ICON_ONLY_NG_STAR_INSERTED = "//button[@class=\"p-element p-ripple p-datepicker-trigger ng-tns-c47-4 p-button p-component p-button-icon-only ng-star-inserted\"]";
