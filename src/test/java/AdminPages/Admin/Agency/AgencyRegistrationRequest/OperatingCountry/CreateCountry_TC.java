package AdminPages.Admin.Agency.AgencyRegistrationRequest.OperatingCountry;
...
//    }
    ...
    public void navigateBackToURL() {
        driver.browser().navigateToURL("http://192.168.1.93/master/flight/preferAirline/add");
    }
}